...
public class ClassKohonenAlgorithm implements IAlgorithm {
	private static IAlgorithm myInstance = new ClassKohonenAlgorithm();
	...
	public String toString() {
		return "Class Kohonen algorithm";
	}
	...
	public List<ComparisonResult> getWholeResults(boolean[] picture) {
		...
		List<ComparisonResult> list = new ArrayList<ComparisonResult>(myDistinctSymbolsNumber);
		int percentage;
