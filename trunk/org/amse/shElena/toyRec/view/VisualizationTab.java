...
public class VisualizationTab extends JPanel {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (file != null) {
					...
					try {
						...
						myPaintingPanel.setDrawingEnabled(true);
						updateActions();
					} catch (IOException e) {
						return;
					}
	...
	private AbstractAction getStartAction() {
		AbstractAction start = new AbstractAction() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				myPaintingPanel.repaint();
				myPaintingPanel.setDrawingEnabled(false);
				updateActions();
			}
	...
	private void updateActions(){
		for(AbstractAction act : myTempActions){
			act.setEnabled(myManager.isHandlingStarted());
		}
		myStartAction.setEnabled(!myManager.isHandlingStarted());
	}
}
